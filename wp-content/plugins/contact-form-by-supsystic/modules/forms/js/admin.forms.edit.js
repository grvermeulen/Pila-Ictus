...
jQuery(document).ready(function(){
	...
	jQuery('#cfsFormShortcodeExampleSel').change(function(){
		jQuery('#cfsFormShortcodeShell, #cfsFormPhpCodeShell, #cfsFormWidgetShell').hide();
		var showId = '';
		switch(jQuery(this).val()) {
			case 'shortcode':
				showId = 'cfsFormShortcodeShell';
				break;
			case 'php_code':
				showId = 'cfsFormPhpCodeShell';
				break;
			case 'widget':
				showId = 'cfsFormWidgetShell';
				break;
		}
		jQuery('#'+ showId).show();
	}).trigger('change');
