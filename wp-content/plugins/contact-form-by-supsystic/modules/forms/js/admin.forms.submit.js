...
,	haveSubmitData: function() {
		return this._$mainShell.find('.cfsFormSubmitToShell:not(#cfsFormSubmitToShellEx)').size();
	}
};
jQuery(document).ready(function(){
	...
	jQuery('.cfsTestEmailFuncBtn').click(function(){
		jQuery.sendFormCfs({
			btn: this
		,	data: {mod: 'mail', action: 'testEmail', test_email: jQuery('#cfsFormSubmitToShellEx input[name="params[tpl][test_email]"]').val()}
