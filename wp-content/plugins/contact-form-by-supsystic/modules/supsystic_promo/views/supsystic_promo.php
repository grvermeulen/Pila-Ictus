...
Here you can edit css style of the pop-up window.', CFS_LANG_CODE),
	...
	public function showWelcomePage() {
		frameCfs::_()->getModule('templates')->loadJqueryUi();
		frameCfs::_()->addStyle('sup.bootstrap', frameCfs::_()->getModule('forms')->getAssetsUrl(). 'css/bootstrap.partial.min.css'/*'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css'*/);
